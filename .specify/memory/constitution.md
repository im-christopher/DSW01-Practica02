...
- Modified principles:
	- Principle 1 placeholder → I. Backend-Only Architecture
	- Principle 2 placeholder → II. Standard Runtime Baseline
	- Principle 3 placeholder → III. Security Baseline (NON-NEGOTIABLE)
	- Principle 4 placeholder → IV. Data & Persistence Discipline
	- Principle 5 placeholder → V. Containerization & API Contract Transparency
- Added sections:
	- Technical Standards
...
### V. Containerization & API Contract Transparency
...
response models. Container build/runtime definitions MUST be reproducible in development
and CI.
...
2. Pull requests MUST confirm: Java 17/Spring Boot 3 compliance, Basic Auth coverage,
	 PostgreSQL alignment, Docker viability, and Swagger documentation completeness.
